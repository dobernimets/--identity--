...
describe("Linksharing", () => {
  ...
  test("GET /linksharings/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/linksharings"}/${nonExistingId}`)
  ...
  test("GET /linksharings/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/linksharings"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
